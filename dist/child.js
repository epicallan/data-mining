...
/***/ function(module, exports, __webpack_require__) {
	...
	connection.once('open', function () {
	  ...
	  Twitter = connection.model('Twitter', _srcModelsTwitter2['default']);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TwWorker = (function () {
	  function TwWorker(data) {
	    ...
	    var userMentionsMatch = _configSettings2['default'].track.split(',');
	    ...
	    value: function addToUserMentions(data, names) {
	      data.forEach(function (d) {
	        names.forEach(function (name) {
	          ...
	          var mentions = d.user_mentions.join(' ');
	          var userMentionsMatch = mentions.match(regex);
	          if (!userMentionsMatch) {
	            // check whether the name is with in the tweet
	            var matchArr = d.text.match(regex);
	            if (matchArr) {
