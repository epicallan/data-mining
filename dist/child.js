...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libUtils = __webpack_require__(199);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libAnalyzer = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Analyzer = (function () {
	  function Analyzer() {
	    ...
	    this.tokenizers = new _salient2['default'].tokenizers.RegExpTokenizer({
	      pattern: /\W+/
	    });
	    this.sentiwordClassifier = new _salient2['default'].sentiment.SentiwordnetAnalyser();
	    this.classifier = new _salient2['default'].sentiment.BayesSentimentAnalyser();
	    this.POSTagger = new _salient2['default'].tagging.HmmTagger();
	  ...
	  _createClass(Analyzer, [{
	    key: '_readInData',
	    value: function _readInData(file) {
	      return JSON.parse(_fs2['default'].readFileSync(file, 'utf8'));
	    }
	  }, {
	    key: '_cleanUpData',
	    value: function _cleanUpData(raw, options) {
	      var data = null;
	      if (options.type === 'topic' || options.type === 'pages') {
	        data = _cleanUp2['default'].assignIds(raw);
	      } else {
	        data = _cleanUp2['default'].tweeterData(raw);
	      }
	      if (options.type === 'topic') data = _cleanUp2['default'].removeSelfPosts(options.poster, data);
	      return data;
	    }
	  }, {
	    key: 'getData',
	    value: function getData(data, options) {
	      return this._cleanUpData(data, options);
	    }
	  }, {
	    key: 'getDataFromFile',
	    value: function getDataFromFile(options) {
	      var data = this._readInData(options.file);
	      return this._cleanUpData(data, options);
	    }
	  }, {
	    key: '_getTopItems',
	    value: function _getTopItems(terms, count) {
	      var aggregated = _lodash2['default'].countBy(terms, function (n) {
	        return n;
	      });
	      aggregated = _lodash2['default'].pairs(aggregated);
	      var myCount = count;
	      var truncated = null;
	      if (!myCount) {
	        ...
	        aggregated = _lodash2['default'].sortBy(aggregated, function (n) {
	          return n[1];
	        });
	    ...
	    key: '_getSentiment',
	    value: function _getSentiment(sentence) {
	      var sentiword = this.sentiwordClassifier.classify(sentence);
	      var simpleBayes = this.classifier.classify(sentence);
	    ...
	    value: function _getKeyWords(text) {
	      ...
	      var nouns = [];
	      if (!_utils2['default'].isEmpty(text)) {
	        var concepts = this.tokenizers.tokenize(text);
	        concepts.forEach(function (concept) {
	          var tag = _this.POSTagger.tag([concept]);
	    ...
	    key: 'addToUserMentions',
	    value: function addToUserMentions(data, names) {
	      data.forEach(function (d) {
	        names.forEach(function (name) {
	          // if a mention fuzzy matches our tracked names then replace
	          // it with our tracker name
	          var nameIsInMention = d.user_mentions.some(function (mention, index, arr) {
	            var bool = false;
	    ...
	    key: '_saveToRedis',
	    value: function _saveToRedis(obj) {
	      this.client.hmset(obj.location, 'lat', obj.lat, 'lng', obj.lng, _redis2['default'].print);
	    }
	  }, {
	    key: '_getFromRedis',
	    value: function _getFromRedis(key) {
	      var _this2 = this;

	      return new Promise(function (resolve, reject) {
	        _this2.client.hgetall(key, function (err, reply) {
	          resolve(reply);
	          reject(err);
	        });
	      });
	    ...
	    key: 'saveJsonRedis',
	    value: function saveJsonRedis(data, key, cb) {
	      this.client.set(key, JSON.stringify(data), function (err, res) {
	    ...
	    key: 'getJsonRedis',
	    value: function getJsonRedis(key, cb) {
	    ...
	    key: 'deletFromRedis',
	    value: function deletFromRedis(keys, cb) {
	      var _this3 = this;

	      _async3['default'].each(keys, function (key, callback) {
	        _this3.client.del(key, function (err) {
	          if (err) callback(err);
	          callback();
	        });
	      }, function (err) {
	    ...
	    key: '_geoCodeLocation',
	    value: function _geoCodeLocation(location, id) {
	      var _this4 = this;

	      if (!location || location.length < 2) {
	        throw new Error('this location ' + location + ' is not searchable');
	      }
	      var urlPart = location.replace(/[\W_]+/g, '+');
	      var url = GEO_CODE_API + urlPart + '&key=' + GOOGLE_API_KEY;
	      return new Promise(function (resolve, reject) {
	    ...
	    key: '_getSavedCoordinates',
	    value: function _getSavedCoordinates(data, cb) {
	      var _this5 = this;

	      _async3['default'].each(data, function callee$2$0(d, callback) {
	        return regeneratorRuntime.async(function callee$2$0$(context$3$0) {
	          while (1) switch (context$3$0.prev = context$3$0.next) {
	            case 0:
	              if (!d.location) {
	              ...
	              context$3$0.next = 3;
	              return regeneratorRuntime.awrap(this._getFromRedis(d.location));

	            case 3:
	              d.coordinates = context$3$0.sent;
	    ...
	    key: 'getCordinates',
	    value: function getCordinates(data, cb) {
	      var _this6 = this;

	      // filter out data with geo-cordinates
	      var geoFiltered = this._filterResidue(data, 'geo_enabled', true);
	      var filtered = geoFiltered.filtered;
	      var residue = geoFiltered.residue;

	      // look through redis for canched locations and co-ordinates (we are mutating the residue data)
	      this._getSavedCoordinates(residue, function (_residue, error) {
	        if (error) throw new Error('Getting coodinates from redis error');
	        _async3['default'].each(_residue, function callee$3$0(d, callback) {
	          var _location;
	          ...
	          return regeneratorRuntime.async(function callee$3$0$(context$4$0) {
	            while (1) switch (context$4$0.prev = context$4$0.next) {
	              case 0:
	                context$4$0.prev = 0;
	                _location = d.location || d.time_zone;

	                if (!(!d.approximated_geo && _location)) {
	                  context$4$0.next = 6;
	                  break;
	                }

	                context$4$0.next = 5;
	                return regeneratorRuntime.awrap(this._geoCodeLocation(_location, d.id));

	              case 5:
	                d.coordinates = context$4$0.sent;
	              ...
	              case 10:
	                ...
	                /* eslint-disable no-console*/
	                console.log(context$4$0.t0.message);
	                callback();
	    ...
	    key: 'fbPostsSentiments',
	    value: function fbPostsSentiments(list, field) {
	      var _this7 = this;

	      return new Promise(function (resolve, reject) {
	        list.forEach(function (post) {
	          var sentiment = null;
	          if (!_utils2['default'].isEmpty(post[field])) {
	            sentiment = _this7.__getSentiment(post[field]);
	    ...
	    key: 'fbPostsCommentsSentiments',
	    value: function fbPostsCommentsSentiments(list) {
	      var _this8 = this;
	      ...
	      list.forEach(function (post) {
	        if (post.comments) {
	          ...
	          post.comments.forEach(function (comment) {
	            if (!_utils2['default'].isEmpty(comment.comment)) {
	              var sentiment = _this8.__getSentiment(comment.comment);
	    ...
	    key: 'fbPostsStats',
	    value: function fbPostsStats(list) {
	      list.forEach(function (post) {
	    ...
	    key: 'fbPostsTerms',
	    value: function fbPostsTerms(list) {
	      var _this9 = this;

	      list.forEach(function (post) {
	        post.terms = _this9.__getKeyWords(post.post);
	        post.comments.forEach(function (comment) {
	          comment.terms = _this9.__getKeyWords(comment.comment);
	        });
	      });
	      return list;
	    }
	  }, {
	    key: 'aggregatePostsTerms',
	    value: function aggregatePostsTerms(count) {
	      var posts = this.fbPostsTerms();
	      var terms = [];
	      ...
	      terms = _lodash2['default'].flatten(terms);
	      var top = this._getTopItems(terms, count);
	      return top;
	    }
	  }, {
	    key: 'fbPagesActiveCommenters',
	    value: function fbPagesActiveCommenters(data, count) {
	      var commenters = [];
	    ...
	    key: 'topFrequentItems',
	    value: function topFrequentItems(data, field, count) {
	    ...
	    key: 'filterData',
	    value: function filterData(data, field, assertion) {
	      return _lodash2['default'].filter(data, function (d) {
	        return d[field] === assertion || d[field].length > 0;
	      });
	    }
	  }, {
	    key: '_filterResidue',
	    value: function _filterResidue(data, field, assertion) {
	      var residue = [];
	      var filtered = _lodash2['default'].filter(data, function (d) {
	        var isFiltered = d[field] === assertion;
	        if (!isFiltered) residue.push(d);
	        return isFiltered;
	      });
	      return {
	        filtered: filtered, residue: residue
	      };
	    }
	  }, {
	    key: 'fbTopicsFrequentPosters',
	    value: function fbTopicsFrequentPosters(data, count) {
	      return this.topFrequentItems(data, 'poster', count);
	    }
	  }, {
	    key: 'groupCountByDate',
	    value: function groupCountByDate(data, options) {
	      ...
	      var grp = this._getTopItems(list, options.count);
	      return grp;
	    }
	  }, {
	    key: 'twTerms',
	    value: function twTerms(data) {
	      var _this10 = this;

	      data.forEach(function (tweet) {
	        tweet.terms = _this10._getKeyWords(tweet.text);
	      });
	      return data;
	    }
	  }, {
	    key: 'topTwTerms',
	    value: function topTwTerms(data, options) {
	      var myData = data;
	      if (options.filterRetweets) {
	        myData = this.filterData(data, 'is_retweet', false);
	      }
	      var termedTweets = this.twTerms(myData);
	      var terms = this.aggregateTerms(termedTweets);
	      var topTerms = this._getTopItems(terms, options.count);
	      return this._excludeTerms(topTerms, options.exclude);
	    }
	  }, {
	    key: '_excludeTerms',
	    value: function _excludeTerms(data, exclude) {
	      var filterd = _lodash2['default'].filter(data, function (obj) {
	        var isFilterdOut = false;
	    ...
	    key: 'aggregateTerms',
	    value: function aggregateTerms(data) {
	      var terms = data.map(function (d) {
	        return d.terms;
	      });
	      var flattenTerms = _lodash2['default'].flatten(terms, true);
	      // console.log(flattenTerms);
	      return flattenTerms;
	    }
	  }, {
	    key: 'tweetSentiments',
	    value: function tweetSentiments(data) {
	      var _this11 = this;

	      data.forEach(function (tweet) {
	        tweet.sentiment = _this11._getSentiment(tweet.text);
	      });
	      return data;
	    }
	  }, {
	    key: 'aggregateTwSentiments',
	    value: function aggregateTwSentiments(data) {
	    ...
	    key: 'nestTweetReplies',
	    value: function nestTweetReplies(data) {
	      var replies = _lodash2['default'].filter(data, function (d) {
	        return d.is_reply;
	      });
	      data.forEach(function (tweet) {
	        tweet.replies = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CleanUp = (function () {
	  ...
	  _createClass(CleanUp, [{
	    key: 'removeSelfPosts',
	    value: function removeSelfPosts(poster, data) {
	      var newData = [];
	      data.forEach(function (d) {
	        if (!_utils2['default'].isEmpty(d.poster)) {
	    ...
	    key: 'assignIds',
	    value: function assignIds(data) {
	      data.forEach(function (post, index) {
	        if (post === undefined) data.splice(index, 1);
	        if (post.id === undefined) post.id = (0, _uid2['default'])(10);
	      });
	      return data;
	    }
	  }, {
	    key: 'fbData',
	    value: function fbData(data) {
	      // TODO make fb data schema match twitters
	      return data;
	    }
	  }, {
	    key: 'convertToDateObjs',
	    value: function convertToDateObjs(data) {
	      data.forEach(function (d) {
	    ...
	    key: 'tweeterData',
	    value: function tweeterData(data) {
	      var twitterData = data.map(function (tweet) {
	        var obj = {};
	        ...
	        if (tweet.entities.hashtags.length) {
	          ...
	          obj.hashtags = tweet.entities.hashtags.map(function (tag) {
	            return tag.text;
	          });
	        } else {
	          obj.hashtags = [];
	        ...
	        if (tweet.entities.user_mentions.length) {
	          ...
	          obj.user_mentions = tweet.entities.user_mentions.map(function (user) {
